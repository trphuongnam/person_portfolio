  ...
  const SOCIALS = [
    {
      key: "facebook",
      label: "Facebook",
      handleLabel: t('page.connect.facebookText'),
    ...
    },
    {
      key: "github",
      label: "Github",
      handleLabel: t('page.connect.githubText'),
      Icon: GithubOutlined,
      color: "#171515",
    ...
    },
    {
      key: "linkedin",
      label: "LinkedIn",
      handleLabel: t('page.connect.linkedinText'),
        ...
        {SOCIALS.map(({ key, label, handleLabel, Icon, color, link }) => (
          ...
          >
            ...
            <span className="flex-1 min-w-0">
              <span className="block text-sm social-item__label">{label}</span>
